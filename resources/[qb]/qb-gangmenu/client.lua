...
local menu_button1 = menu:AddButton({
    ...
    label = 'Rekruter',
    value = menu4,
    description = 'Rekruter nye Ansatte'
})
...
local menu_button6 = menu2:AddButton({
    ...
    label = 'Hæb',
    value = menu2,
    description = 'Hæv samfundsbeløb'
})
local menu_button7 = menu2:AddButton({
    icon = '🏦',
    label = 'Indsæt',
    value = menu2,
    description = 'Indsæt samfundspenge'
})
...
menu_button6:On("select", function()
    ...
    if result ~= nil and PlayerGang.name and PlayerGang.isboss then
        ...
        QBCore.Functions.Notify('Ikke høj nok rengeret snak med din chef!', "error")
    end
end)
