...
local menu_button = menu:AddButton({
    ...
    label = 'Ansatte',
    value = menu3,
    description = 'styr Ansatte'
})
local menu_button1 = menu:AddButton({
    icon = '🤝',
    label = 'Rekrutter',
    value = menu4,
    description = 'Rekrutter nye medarbejdere'
})
...
local menu_button4 = menu:AddButton({
    icon = '💰',
    label = 'Samfunds penge',
    value = menu2,
    description = 'Se/administrer samfundspenge'
})
local menu_button5 = menu2:AddButton({
    icon = '💲',
    label = '',
    value = nil,
    description = 'Nuværende samfundsbeløb'
})
local menu_button6 = menu2:AddButton({
    icon = '🤑',
    label = 'Hæv',
    value = menu2,
    description = 'Hæv penge fra arbejdskassen'
})
local menu_button7 = menu2:AddButton({
    icon = '🏦',
    label = 'Indsæt',
    value = menu2,
    description = 'Indsæt penge i arbejdskassen'
})
...
function ManageEmployees(employee)
    ...
    buttons = {
        ...
        [3] = {
            ...
            label = "fyr",
            value = "Fire",
            description = "Fyr en person " .. employee.name
        }
    }
            ...
            local menu_button9 = manageroptions:AddButton({
                ...
                select = function(btn)
                    ...
                    if values == 'promote' then
                        local result = LocalInput('Nyt klassetrin', 3, '')
                        if result ~= nil then
