...
RegisterNetEvent('qb-diving:client:SetDivingLocation', function(DivingLocation)
    ...
    CreateThread(function()
        ...
        AddTextComponentSubstringPlayerName('Dykkerområde')
...
RegisterNetEvent('qb-diving:server:CallCops', function(Coords, msg)
    ...
    BeginTextCommandSetBlipName('STRING')
    AddTextComponentString("911 - Dykkerområde")
...
RegisterNetEvent('qb-diving:client:UseGear', function(bool)
    if bool then
        ...
        QBCore.Functions.Progressbar("equip_gear", "Tager dykkerdragt på", 5000, false, true, {}, {}, {}, {}, function() -- Done
            ...
            TriggerEvent('chatMessage', "SYSTEM", "error", "/divingsuitfor at tage din dykkerdragt af")
        end)
    else
        if currentGear.enabled then
            GearAnim()
            QBCore.Functions.Progressbar("remove_gear", "Træk en dykkerdragt frem ..", 5000, false, true, {}, {}, {}, {}, function() -- Done
                DeleteGear()
            ...
            QBCore.Functions.Notify('Du har ikke dykkerudstyr på..', 'error')
        end
    end
end)
                        ...
                        if CoralDistance <= 30 then
                            if not CoralLocation.PickedUp then
                                ...
                                if CoralDistance <= 1.5 then
                                    DrawText3D(CoralLocation.coords.x, CoralLocation.coords.y, CoralLocation.coords.z, '[E] Samler koraller')
