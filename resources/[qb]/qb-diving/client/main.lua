...
RegisterNetEvent('qb-diving:client:UseJerrycan', function()
    ...
    if boat then
        ...
        QBCore.Functions.Progressbar("reful_boat", "Tanker båd..", 20000, false, true, {
            ...
            QBCore.Functions.Notify('Båden er tanket', 'success')
            ...
            QBCore.Functions.Notify('Brændstofpåfyldning er blevet anulleret!', 'error')
        end)
    else
