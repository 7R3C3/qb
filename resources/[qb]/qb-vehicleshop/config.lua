    ...
    ['pdm'] = {
        ...
        ['ShowroomVehicles'] = {
            [1] = {
                ...
                defaultVehicle = 'mcjcw20', -- Default display vehicle
                chosenVehicle = 'mcjcw20', -- Same as default but is dynamically changed when swapping vehicles
            },
            [2] = {
                coords = vector4(-48.27, -1101.86, 25.44, 294.5),
                defaultVehicle = 'guilia',
                chosenVehicle = 'guilia',
            },
            [3] = {
                coords = vector4(-39.6, -1096.01, 25.44, 66.5),
                defaultVehicle = 'cliors',
                chosenVehicle = 'cliors',
            },
            [4] = {
                coords = vector4(-51.21, -1096.77, 25.44, 254.5),
                defaultVehicle = 'punto',
                chosenVehicle = 'punto',
            },
            [5] = {
            ...
            [6] = {
                ...
                defaultVehicle = '206fn',
                chosenVehicle = '206fn',
            },
            [7] = {
                coords = vector4(-50.66, -1093.05, 25.44, 222.5),
                defaultVehicle = 'ibiza',
                chosenVehicle = 'ibiza',
            },
            [8] = {
