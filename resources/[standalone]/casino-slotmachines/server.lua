...
QBCore.Functions.CreateCallback('BLACKJACK:server:whiteChipsAmount', function(source, cb)
    local retval = 0
...
function CheckForWin(w, data)
	...
	if total > 0 then
		...
		if Player.Functions.AddItem('casino_whitechip', total, nil, {["quality"] = 100}) then
