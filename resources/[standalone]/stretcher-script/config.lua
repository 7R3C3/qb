...
Config.Hash = {
	...
	{hash = "gul", detection = 4.2, depth = -1.0, height = -0.245},
	{hash = "hvid", detection = 4.1, depth = -1.0, height = -0.15},
}
...
Config.Language = {
	name_hospital = 'Båre',
	open_menu = 'Klik ~b~E',
	do_action = 'Klik på ~INPUT_CONTEXT~ at interagere med båre',
	take_bed = "Klik på ~INPUT_CONTEXT~ for at tage båren",
	release_bed = "Klik på ~INPUT_CONTEXT~ at slippe båre",
	in_vehicle_bed = "Klik på ~INPUT_CONTEXT~ for at ligge båren",
	out_vehicle_bed = "Klik på ~INPUT_CONTEXT~ for at hente båre",
	go_out_bed = "Stå op af sengen",
	delete_bed = "Fjern sengen",
	toggle_backboard = "vælg bagplade",
	lit_1 = "Seng uden matela",
	toggle_seat = "Fold sædet",
	toggle_lifepak = "Vælg lifepak",
	toggle_bag = "Vælg taske",
	toggle_backpack = "Vælg rygsæk",
	anim = {
